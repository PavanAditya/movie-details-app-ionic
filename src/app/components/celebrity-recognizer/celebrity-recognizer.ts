...
@Component({
  ...
  template: `
    <ion-button *ngIf="!processing" (click)="fileChooserInput.click()">Select photo</ion-button>
...
export class CelebrityRecognizerComponent implements OnInit {
  ...
  onImageSelected(event: any) {
    ...
    this.ngxPicaService.compressImage(event.target.files[0] as File, 0.5).subscribe((file: File) => {
